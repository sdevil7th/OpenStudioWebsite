...
const doc: DocContent = {
  ...
  blocks: [
    ...
    },
    {
      ...
      caption:
        "Note blobs on the piano grid with the detected contour. The scale and key controls decide where notes snap.",
    },
    {
      type: "p",
      text: `This is different from the clip-level **pitch shift** in the arrangement, which transposes a whole clip and, like time stretch, uses FFmpeg on macOS and Linux. The Pitch Editor works note by note. It is also separate from hosting a third-party pitch editor over ARA; see [Plugins & scanning](${SITE_PATHS.docs}/plugins-and-scanning) for that path.`,
    },
    ...
    },
    {
      ...
      rows: [
        ...
        [
          "**Split**",
          "Divides one detected note into two, for when segmentation merged two pitches or a phrase needs a cut.",
        ],
      ],
    },
    {
