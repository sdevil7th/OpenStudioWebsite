...
const doc: DocContent = {
  ...
  blocks: [
    ...
    {
      type: "p",
      text: `If a key stops working, check focus first (a focused text field disables shortcuts until you press \`Esc\`), then confirm the selected profile, the platform override, and the action's scope in the shortcut window. The full checklist is in [Troubleshooting](${SITE_PATHS.docs}/troubleshooting).`,
    },
  ],
};
