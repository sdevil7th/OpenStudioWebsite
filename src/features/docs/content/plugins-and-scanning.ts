...
const doc: DocContent = {
  ...
  blocks: [
    ...
    {
      type: "p",
      text: `Two larger built-ins have their own pages: the guitar and bass capture host in [NAM Rack setup](${SITE_PATHS.docs}/nam-rack-setup), and the real-time pitch corrector in [Pitch editing](${SITE_PATHS.docs}/pitch-editing). A limiter is also built in, and S13FX script effects with sliders and a native editor are supported.`,
    },
