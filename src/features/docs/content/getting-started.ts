  ...
  blocks: [
    ...
    },
    {
      ...
      rows: [
        [
          "Windows",
          "Run the installer. If SmartScreen appears, choose **More info** → **Run anyway**. The installer owns the WebView2 and VC++ prerequisites.",
        ],
        [
          "macOS",
          "Open the .dmg and drag OpenStudio to Applications. Right-click the app, choose **Open**, then allow it under **System Settings → Privacy & Security** if asked.",
        ],
        [
          "Linux",
    ...
    {
      type: "p",
      text: `Latency, crackle, and driver choice get their own page: [Audio setup](${SITE_PATHS.docs}/audio-setup).`,
    },
    ...
    {
      type: "p",
      text: `VST3 is the most mature path; CLAP and LV2 compatibility varies more by plugin. Nothing showing up? See [Plugins & scanning](${SITE_PATHS.docs}/plugins-and-scanning).`,
    },
