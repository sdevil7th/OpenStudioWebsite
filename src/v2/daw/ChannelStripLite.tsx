...
export const ChannelStripLite = memo(function ChannelStripLite({
  ...
  return (
    ...
    >
      ...
      <div className="overflow-hidden min-h-0">
        ...
        {isMaster && (
          <div className="flex gap-0.5 p-1 shrink-0">
            <DawButton variant="default" size="xs" active={muted} title="Mute" aria-label="Mute master" className="flex-1">
              M
            </DawButton>
            <DawButton
              variant="default"
              ...
              className={cn("flex-1", mono ? "bg-yellow-600 text-white border-yellow-500" : "hover:border-yellow-500 hover:text-yellow-300")}
            >
              MONO
            </DawButton>
          </div>
      ...
      {!isMaster && (
        <div className="flex gap-0.5 p-1 shrink-0">
          <DawButton variant="default" size="xs" active={muted} title="Mute" aria-label={`Mute track ${name}`} className="flex-1">
            M
          </DawButton>
          <DawButton variant="warning" size="xs" active={soloed} title="Solo" aria-label={`Solo track ${name}`} className="flex-1">
            S
          </DawButton>
          <DawButton
            variant="danger"
